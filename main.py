...
async def set_role(callback: types.CallbackQuery):
    ...
    await callback.message.answer(f"✅ Tabriklaymiz! Siz endi {role} rolidasiz. Botni yangilash uchun /start bosing.")

# --- 3. LOKATSIYA VA BUYURTMA ---
